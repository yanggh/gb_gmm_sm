...
void quality_of_service(uint8_t iei, uint8_t location, int ms_to_net)
{
    ...
    if(len > 0)
    {
        ...
        {
            A_B8_BIT2(gbf, maximum_bit_rate_for_uplink, "Maximum bit rate for uplink", 1, 8, "The maximum bit rate is 64 kbps + ((the binary coded value in 8 bits â€?01000000) * 8 kbps)");
        }
        else if(tmp == 127)
        {
        ...
        {
            A_B8_BIT2(gbf, maximum_bit_rate_for_uplink, "Maximum bit rate for uplink", 1, 8, "The maximum bit rate is 576 kbps + ((the binary coded value in 8 bits â€?10000000) * 64 kbps)");
        }
        else if(tmp == 254)
        {
    ...
    if(len > 0)
    {
        ...
        {
            A_B8_BIT2(gbf, maximum_bit_rate_for_downlink, "Maximum bit rate for downlink", 1, 8, "The maximum bit rate is 64 kbps + ((the binary coded value in 8 bits â€?01000000) * 8 kbps)");
        }
        else if(tmp == 127)
        {
        ...
        {
            A_B8_BIT2(gbf, maximum_bit_rate_for_downlink, "Maximum bit rate for downlink", 1, 8, "The maximum bit rate is 576 kbps + ((the binary coded value in 8 bits â€?10000000) * 64 kbps)");
        }
        else if(tmp == 254)
        {
    ...
    if(len > 0)
    {
        ...
        {
            A_B8_BIT2(gbf, transfer_delay, "Transfer delay", 3, 8, "The transfer delay is 200 ms + ((the binary coded value in 6 bits â€? 010000) * 50 ms)");        
        }
        else if(tmp == 31)
        {
        ...
        {
            A_B8_BIT2(gbf, transfer_delay, "Transfer delay", 3, 8, "The transfer delay is 1000 ms + ((the binary coded value in 6 bits â€? 100000) * 100 ms)");        
        }
        else if(tmp == 62)
        {
...
void sm_cause(uint8_t iei, uint8_t location)
{
    ...
    B8_HEX();
    B8_BIT(tmp, 1, 8);
    if(tmp == 8 || (tmp >= 24 && tmp <= 48) || tmp == 50 || tmp == 51 || tmp == 51 || tmp == 52 || tmp == 56 || tmp == 60 || tmp == 65 || tmp == 66 || tmp == 81 || tmp == 95 || tmp == 96 || tmp == 97 || tmp == 98 || tmp == 99 || tmp == 100 || tmp == 111 || tmp == 112)
    {
