...
#include "nbe_pu_gbf.h"
#include "nbp_bvc_block.h"

#define NPCTX      struct bvc_block_ctx*
...
{{ 
      ...
      BEGIN_SIGNAL("2", "BSSGP Layer", "BVC-BLOCK");
...
void *bvc_block_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct bvc_block_ctx));
    if (!pState) {
