...
#include "nbe_pu_gbf.h"
#include "nbp_request_mbms_context_activation.h"

#define NPCTX      struct request_mbms_context_activation_ctx*
...
struct request_mbms_context_activation_ctx {
    scan_state __ss;
    nbe_pu_gb *gb;
...
void *request_mbms_context_activation_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct request_mbms_context_activation_ctx));
    if (!pState) {
