...
#include "nbe_pu_gbf.h"
#include "nbp_authentication_and_ciphering_failure.h"

#define NPCTX      struct authentication_and_ciphering_failure_ctx*
...
struct authentication_and_ciphering_failure_ctx {
    scan_state __ss;
    nbe_pu_gb *gb;
...
void *authentication_and_ciphering_failure_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct authentication_and_ciphering_failure_ctx));
    if (!pState) {
