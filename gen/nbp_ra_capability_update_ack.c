...
#include "nbe_pu_gbf.h"
#include "nbp_ra_capability_update_ack.h"

#define NPCTX      struct ra_capability_update_ack_ctx*
...
struct ra_capability_update_ack_ctx {
    scan_state __ss;
    nbe_pu_gb *gb;
...
void *ra_capability_update_ack_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct ra_capability_update_ack_ctx));
    if (!pState) {
