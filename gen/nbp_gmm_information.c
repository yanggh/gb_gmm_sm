...
#include "nbe_pu_gbf.h"
#include "nbp_gmm_information.h"

#define NPCTX      struct gmm_information_ctx*
...
void *gmm_information_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct gmm_information_ctx));
    if (!pState) {
