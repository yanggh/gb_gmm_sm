...
#include "nbe_pu_gbf.h"
#include "nbp_identity_request.h"

#define NPCTX      struct identity_request_ctx*
...
{{ 
	...
	BEGIN_SIGNAL("4", "GMM", "IDENTITY REQUEST");
...
void *identity_request_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct identity_request_ctx));
    if (!pState) {
