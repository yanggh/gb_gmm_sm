...
#include "nbe_pu_gbf.h"
#include "nbp_activate_mbms_context_request.h"

#define NPCTX      struct activate_mbms_context_request_ctx*
...
struct activate_mbms_context_request_ctx {
    scan_state __ss;
    nbe_pu_gb *gb;
...
void *activate_mbms_context_request_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct activate_mbms_context_request_ctx));
    if (!pState) {
