...
#include "nbe_pu_gbf.h"
#include "nbp_flow_control_ms.h"

#define NPCTX      struct flow_control_ms_ctx*
...
void *flow_control_ms_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct flow_control_ms_ctx));
    if (!pState) {
