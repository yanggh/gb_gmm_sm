...
#define NPCTX      struct fr_layer_ctx*
...
void *fr_layer_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct fr_layer_ctx));
    if (!pState) {
