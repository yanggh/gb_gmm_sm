...
#include "nbe_pu_gbf.h"
#include "nbp_transport.h"

#define NPCTX      struct transport_ctx*
...
void *transport_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct transport_ctx));
    if (!pState) {
...
int transport_get_param(void *pState, int index, void *param, int len) {
    ...
    switch (index) {
        case 1:
           ...
           break;
        case 2:
           memcpy(param, &pctx->protocol, len);
           break;
        default:
            return -1;
    }
...
int transport_set_param(void *pState, int index, void *param, int len) {
    ...
    switch (index) {
        case 1:
           ...
           break;
        case 2:
           memcpy(&pctx->protocol, param, len);
           break;
        default:
            return -1;
    }
