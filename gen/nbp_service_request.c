...
#include "nbe_pu_gbf.h"
#include "nbp_service_request.h"

#define NPCTX      struct service_request_ctx*
...
void *service_request_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct service_request_ctx));
    if (!pState) {
