...
#include "nbe_pu_gbf.h"
#include "nbp_authentication_and_ciphering_request.h"

#define NPCTX      struct authentication_and_ciphering_request_ctx*
...
struct authentication_and_ciphering_request_ctx {
    scan_state __ss;
    nbe_pu_gb *gb;
...
void *authentication_and_ciphering_request_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct authentication_and_ciphering_request_ctx));
    if (!pState) {
