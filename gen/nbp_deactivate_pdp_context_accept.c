...
#include "nbe_pu_gbf.h"
#include "nbp_deactivate_pdp_context_accept.h"

#define NPCTX      struct deactivate_pdp_context_accept_ctx*
...
struct deactivate_pdp_context_accept_ctx {
    scan_state __ss;
    nbe_pu_gb *gb;
...
void *deactivate_pdp_context_accept_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct deactivate_pdp_context_accept_ctx));
    if (!pState) {
