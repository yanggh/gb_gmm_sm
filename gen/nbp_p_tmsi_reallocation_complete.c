...
#include "nbe_pu_gbf.h"
#include "nbp_p_tmsi_reallocation_complete.h"

#define NPCTX      struct p_tmsi_reallocation_complete_ctx*
...
struct p_tmsi_reallocation_complete_ctx {
    scan_state __ss;
    nbe_pu_gb *gb;
...
void *p_tmsi_reallocation_complete_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct p_tmsi_reallocation_complete_ctx));
    if (!pState) {
