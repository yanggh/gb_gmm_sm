...
#include "nbe_pu_gbf.h"
#include "nbp_attach_complete.h"

#define NPCTX      struct attach_complete_ctx*
...
void *attach_complete_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct attach_complete_ctx));
    if (!pState) {
