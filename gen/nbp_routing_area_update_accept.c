...
#include "nbe_pu_gbf.h"
#include "nbp_routing_area_update_accept.h"

#define NPCTX      struct routing_area_update_accept_ctx*
...
struct routing_area_update_accept_ctx {
    scan_state __ss;
    nbe_pu_gb *gb;
...
void *routing_area_update_accept_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct routing_area_update_accept_ctx));
    if (!pState) {
