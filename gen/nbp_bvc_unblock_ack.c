...
#include "nbe_pu_gbf.h"
#include "nbp_bvc_unblock_ack.h"

#define NPCTX      struct bvc_unblock_ack_ctx*
...
{{ 
      ...
      BEGIN_SIGNAL("2", "BSSGP Layer", "BVC-UNBLOCK-ACK");
...
void *bvc_unblock_ack_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct bvc_unblock_ack_ctx));
    if (!pState) {
