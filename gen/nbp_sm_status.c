...
#include "nbe_pu_gbf.h"
#include "nbp_sm_status.h"

#define NPCTX      struct sm_status_ctx*
...
void *sm_status_state_new(nbp_pd_extract_context *extctx){
    NPCTX pState = (NPCTX) malloc(sizeof(struct sm_status_ctx));
    if (!pState) {
